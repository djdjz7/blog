...
function formatDate(time: string | undefined) {
  ...
  if (date.getFullYear() == 1970) return time
...
<template>
  <div class="recent-post" relative h-lg>
    <img
      ...
      object-cover
      :src="
        frontmatter.splash == undefined ? '/assets/img/placeholder.webp' : frontmatter.splash
      " />
    <div
    ...
    <div
      ...
      <div absolute top-0 right-0 flex gap-4>
        <button
          ...
          <span :class="{ 'vpi-moon': isDark, 'vpi-sun': !isDark }" h-4 w-4 block> </span>
        </button>
        <a
      ...
      <div absolute bottom-0 left-0 flex="~ col" gap-3>
        ...
        <a
          ...
          <BookOpenIcon class="text-white/90 h-5 w-5"></BookOpenIcon>Read more...
        </a>
      </div>
      <div
